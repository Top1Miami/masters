...
from experiment.AlphaEnumerationExperiment import AlphaEnumerationExperiment
...
experiment = AlphaEnumerationExperiment(number_samples, baseline, filters, save_path, points=points, delta=0.05,
