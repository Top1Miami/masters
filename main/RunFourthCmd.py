...
np.vstack((points, np.random.random_sample(size=(10, len(filters)))))
# example of save_path '../results/{0}/pmelif_plots/'
experiment = FourthPipelineExperiment(number_samples, baseline, filters, save_path, points=points, delta=0.05,
